...
class App(tk.Tk):
    def __init__(self, title, size):
        ...
        # self.label0 = tk.Label(self, text='Warframes Built')
        # self.label0.pack(padx=10, pady=10)

        # # frame for full lists of built warframes
        # self.builtframe = tk.Frame(self)
        ...
        # self.builtframelabel = tk.Label(self.builtframe, text='List all frames for selected user')
        ...
        # self.bframelabel = tk.Label(self.bframe, text='Both fields must be completed for specific user/frame searches')
...
#         self.initUI()
    ...
    #         result = cur.fetchone()
    #         if result is None: print('User has not built this warframe')
